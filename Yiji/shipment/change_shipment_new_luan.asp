...
%>
    <script language="javascript">
    alert("ÓÃ»§<%=rs_lock("username")%>ÕýÔÚ±à¼­¸Ã¼ÇÂ¼£¡ÇëÉÔºóÔÙÊÔ£¡");
...
if request("dongjian")="µ¥»÷Ñ¡Ôñ¶¯¼ìÖ¤" then
  rs("dongjian")=""
else
  rs("dongjian")=request("dongjian")
end if
rs("zidongcom")=request("zidongcom")
if request("zidong")="µ¥»÷Ñ¡Ôñ×Ô¶¯Ö¤" then
  rs("zidong")=""
else
...
sql="insert into shipmentitem(shipmentnum,itemnum,material,customer,spec,contractweight,contractweightuom,actualnetweight,actualnetweightuom,purchaseprice,purchasepriceunit,productiondate,casenumber,invoiceamount,invoicecurrency,finalpayment,finalpaymentcurrency) values("&request("shipment")&",'"&nowitemno&"','"&nowmatitem&"','"&nowcusitem&"','"&nowspecitem&"','"&nowcontweightitem&"','¹«½ï','"&nowactualweightitem&"','¹«½ï','"&nowpurpriceitem&"','¹«½ï',#"&nowproducedateitem&"#,'"&nowcasenumitem&"',"&nowinvamtitem&",'"&nowcurritem&"',"&nowfinalamtitem&",'"&nowcurritem&"')"

'sql="insert into shipmentitem(shipmentnum,itemnum,material,customer,spec,contractweight,contractweightuom,actualnetweight,actualnetweightuom) values("&request("shipment")&","&nowitemno&",'"&nowmatitem&"','"&nowcusitem&"','"&nowspecitem&"',"&nowcontweightitem&",'¹«½ï',"&nowactualweightitem&",'¹«½ï')"
conn.execute(sql)
