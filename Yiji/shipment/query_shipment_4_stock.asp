  ...
  %>
    ...
    <tr align="center" 
        onDblClick="window.opener.document.<%=request("queryform")%>.<%=request("refship")%>.value='<%=rs_shipment("shipmentnum")%>';
                    ...
                    window.opener.document.<%=request("queryform")%>.<%=request("producedate")%>.value='<%=rs_shipment("productiondate")%>';      
                    window.opener.document.<%=request("queryform")%>.<%=request("price")%>.value='<%=rs_shipment("purchaseprice")%>';         
                    window.opener.document.<%=request("queryform")%>.<%=request("currency")%>.value='<%=rs_shipment("trancurrency")%>';    
                    window.close();" 
