...
<table align="center" cellpadding="4" cellspacing="1" class="toptable grid" border="1">
      ...
      <tr>	  
        ...
        <td class="category">
					...
					&nbsp;&nbsp;&nbsp;国别
					<input name="guobie" style="width:100px">
				&nbsp;&nbsp;&nbsp;合同号	
				<input name="contract" style="width:150px" maxlength="20">
				</td>
      </tr>       
      <tr>	  
	    	<td align="right" height="30">品名：</td>
			<td class="category">
          <input name="material" style="width:100px">
		  		&nbsp;&nbsp;&nbsp;规格
		  		...
		  		&nbsp;&nbsp;&nbsp;币种
					<input name="currency" style="width:100px">
			</td>
      </tr>
      <tr>	  
