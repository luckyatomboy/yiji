...
sql="insert into shipment(shipmentnum,trantype,status,invoicestatus,customer,vendor,contract,country,incoterm,dongjiancom,dongjian,zidongcom,zidong,planship,plant,createdate,creator) values("&nowshipment&",'"&nowtrantype&"','"&nowstatus&"','"&nowinvoicestatus&"','"&nowcustomer&"','"&nowvendor&"','"&nowcontract&"','"&nowcountry&"','"&nowincoterm&"','"&nowdongjiancom&"','"&nowdongjian&"','"&nowzidongcom&"','"&nowzidong&"','"&nowplanship&"','"&nowplant&"',#"&now()&"#,'"&session("redboy_username")&"')"
conn.execute(sql)
...
nowproducedateitem=request("produceDate"&request("itemno")(i))
...
//设置付款条件   
  ...
  function addNewRow(){
   ...
   var newTdObj3=myNewRow.insertCell(2);
	 newTdObj3.innerHTML="<select name='material' id='material' style='width:100px'>"
...
//   newTdObj4.innerHTML="<input type='text' name='customer"+itemNo+"' id='customer"+itemNo+"' />";
	 newTdObj4.innerHTML="<select name='customer' id='customer' style='width:100px'>"
	    +" <% for i = 0 to customerCount-1 %>"
	 		+" <option value='<%=customer(i)%>'><%=customer(i)%></option>"
	 		+" <% next %> </select>";   
   var newTdObj5=myNewRow.insertCell(4);
   newTdObj5.innerHTML="<input type='text' name='spec' id='spec' style='width:100px'/>";   
   var newTdObj6=myNewRow.insertCell(5);
   newTdObj6.innerHTML="<input type='text' name='contractWeight' id='contractWeight' style='width:80px' value=0 onKeyPress=\""+"javascript:CheckNum();\""+" onKeyUp=\""+"this.value=this.value.replace(/[^\\d.]/g,'')\""+">";   		 
   var newTdObj7=myNewRow.insertCell(6);
   newTdObj7.innerHTML="公斤";   
   var newTdObj8=myNewRow.insertCell(7);
   newTdObj8.innerHTML="<input type='text' name='actualWeight' id='actualWeight' style='width:80px' value=0 onKeyPress=\""+"javascript:CheckNum();\""+" onKeyUp=\""+"this.value=this.value.replace(/[^\\d.]/g,'')\""+">";   		 
   var newTdObj9=myNewRow.insertCell(8);
   newTdObj9.innerHTML="<input type='text' name='purchasePrice' id='purchasePrice' style='width:80px' value=0 onKeyPress=\""+"javascript:CheckNum();\""+" onKeyUp=\""+"this.value=this.value.replace(/[^\\d.]/g,'')\""+">";   		 
...
//   	+ " <img src='../images/date.gif' align='absmiddle' style='cursor:pointer;'" 
   ...
   var newTdObj12=myNewRow.insertCell(11);   	//箱数
	 newTdObj12.innerHTML="<input name='casenum' id='casenum' style='width:80px' onKeyPress=\""+"javascript:CheckNum();\""+" onKeyUp=\""+"this.value=this.value.replace(/[^\\d.]/g,'')\""+">";   	
   var newTdObj13=myNewRow.insertCell(12);   	//发票总金额
	 newTdObj13.innerHTML="<input name='invAmount' id='invAmt' style='width:80px' value=0 onKeyPress=\""+"javascript:CheckNum();\""+" onKeyUp=\""+"this.value=this.value.replace(/[^\\d.]/g,'')\""+">";   		 
   var newTdObj14=myNewRow.insertCell(13);
   newTdObj14.innerHTML="<select name='invCurr' id='invCurr' style='width:50px'>"
	 		+" <option value='美元'>美元</option>"
	 		+" <option value='澳币'>澳币</option>"
	 		+" </select>";   
   var newTdObj15=myNewRow.insertCell(14);   	//尾款金额
	 newTdObj15.innerHTML="<input name='finalAmount' id='finalAmt' style='width:80px' value=0 onKeyPress=\""+"javascript:CheckNum();\""+" onKeyUp=\""+"this.value=this.value.replace(/[^\\d.]/g,'')\""+">";   		 
