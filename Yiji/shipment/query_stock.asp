...
<table align="center" cellpadding="4" cellspacing="1" class="toptable grid" border="1">
  ...
  <tr align="center">
  	<td class="category" width="120" height="30">现货合同编号</td>
  	<td class="category" width="80" height="30">公司名称</td>
  	<td class="category" width="80" height="30">客户</td>
  	<td class="category" width="80" height="30">件数</td>
