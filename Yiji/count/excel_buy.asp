...
nowkeyword=request("keyword")
  ...
  if nowkeyword<>"" then
    sql=sql&" and (batch  like '%"&nowkeyword&"%' or orderid  like '%"&nowkeyword&"%' or bianhao = '"&nowkeyword&"' or id_gys in (select id from gys where company like '%"&nowkeyword&"%') or id_login in (select id from login where username like '%"&nowkeyword&"%') or bianhao in (select bianhao from buy where type=0 and (title like '%"&nowkeyword&"%' or huohao like '%"&nowkeyword&"%')))"
  end if
