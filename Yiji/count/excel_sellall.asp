...
nowkeyword=request("keyword") 
	...
	if session("redboy_id")="1" or fla88="1" then
  ...
  sql="select * from sell where type=0 and zu = false and isok"
  if session("redboy_id")<>1 and lookbuysell="yes" and fla89="0" then
  ...
  if nowkeyword<>"" then
    sql=sql&" and (batch  like '%"&nowkeyword&"%' or orderid  like '%"&nowkeyword&"%' or bianhao = '"&nowkeyword&"' or id_huiyuan in (select id from huiyuan where username like '%"&nowkeyword&"%') or id_login in (select id from login where username like '%"&nowkeyword&"%') or bianhao in (select bianhao from sell where type=0 and (title like '%"&nowkeyword&"%' or huohao like '%"&nowkeyword&"%')))"
  end if
...
<td align="center"><%=rs_buy("bianhao")&""%></td>
		  <td align="center"><%=rs_buy("huohao")%></td>
		  <td align="center"><%=rs_buy("title")%></td>
