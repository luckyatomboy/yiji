      ...
      <tr>
        ...
        <td class="category">
		  ...
		  <input type="hidden" name="hid1" value="ok">
			<input type="button" value=" 放弃修改返回 " onClick="if (confirm('确定要放弃修改吗？')) {window.open('delete_lock_table.asp?tablename=customer&combinedkey=<%=request("customername")%>'); window.history.go(-2);}" class="button>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
			<%
