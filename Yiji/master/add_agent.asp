...
sql="insert into Agent(Company,Address,Tel,Fax,Email,Memo,CreateDate,Creator) values('"&nowcompany&"','"&nowaddress&"','"&nowtel&"','"&nowfax&"','"&nowemail&"','"&nowmemo&"',#"&now()&"#,'"&session("redboy_username")&"')"
conn.execute(sql)
%>
<script language="javascript">
alert("代理公司添加成功！")
