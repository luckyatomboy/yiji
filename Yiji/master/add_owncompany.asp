...
<table align="center" cellpadding="4" cellspacing="1" class="toptable grid" border="1">
      ...
      <tr>
        ...
        <td class="category"><input type="text" name="bankaccount" style="width:250px"></td>
      </tr>   
      <tr>
        <td align="right" height="30">开户行：</td>
        <td class="category"><input type="text" name="bankname" style="width:250px"></td>
      </tr>          
      <tr>
...
sql="insert into Owncompany(Company,Address,Tel,Fax,Email,bankaccount,bankname,Memo,CreateDate,Creator) values('"&nowcompany&"','"&nowaddress&"','"&nowtel&"','"&nowfax&"','"&nowemail&"','"&nowaccount&"','"&nowbankname&"','"&nowmemo&"',#"&now()&"#,'"&session("redboy_username")&"')"
conn.execute(sql)
%>
<script language="javascript">
alert("本司公司添加成功！")
