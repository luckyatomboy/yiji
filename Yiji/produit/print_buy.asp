...
<table width="98%" border="0" cellpadding="0" cellspacing="2" align="center">
  ...
  <tr> 
    <td height="21" align="right">
	  供应商：<input type="text" value="<%if rs_gys.eof then%><%=rs_buy("gys")%><%else%><%=rs_gys("company")%><%end if%>" size="20" style="border-bottom:solid 1 #000000;border-top:solid 0 #000000;border-left:solid 0 #000000;border-right:solid 0 #000000;">&nbsp;&nbsp;
	  入库日期：<input type="text" value="<%=rs_buy("selldate")%>" size="20" style="border-bottom:solid 1 #000000;border-top:solid 0 #000000;border-left:solid 0 #000000;border-right:solid 0 #000000;">&nbsp;&nbsp;
...
<table width="98%" border="1" cellspacing="0" cellpadding="2" align="center" bordercolor="#000000">
  ...
  <tr>
	...
	<td align="center"><%=formatnumber(rs_buy("price2")*rs_buy("shulian"),3)%></td>
  </tr>
  <%
  ...
  <tr>
	...
	<td align="center"><%=formatnumber(totalprice2,3)%></td>
  </tr>
</table>
<table width="98%" border="0" cellpadding="0" cellspacing="2" align="center">
  <tr> 
    <td height="21" align="right">
	  ...
	  付款人：<input type="text" value="<%if rs_login.eof then%><%=rs_buy("login")%><%else%><%=rs_login("username")%> (<%=rs_login("bianhao")%>)<%end if%>" size="20" style="border-bottom:solid 1 #000000;border-top:solid 0 #000000;border-left:solid 0 #000000;border-right:solid 0 #000000;">&nbsp;&nbsp;
	</td>
  </tr>
</table>
<!--endprint-->
