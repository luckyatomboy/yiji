...
<table width="98%" border="0" cellpadding="0" cellspacing="2" align="center">
  <tr> 
    <td height="21" align="center"><h1>商品报废单</h1></td>
  </tr>
  <tr> 
    <td height="21" align="right">
	  报废日期：<input type="text" value="<%=rs_buy("selldate")%>" size="20" style="border-bottom:solid 1 #000000;border-top:solid 0 #000000;border-left:solid 0 #000000;border-right:solid 0 #000000;">&nbsp;&nbsp;
