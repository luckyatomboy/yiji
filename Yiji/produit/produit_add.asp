...
sql="insert into buy(batch,orderid,id_produit,bigclass,smallclass,title,huohao,id_ku,ku,shulian,guige,id_login,login,type,selldate,price2,photo,id_gys,gys,bianhao) values('"&batch&"','"&orderid&"',"&rs_produit("id")&",'"&rs_bigclass(0)&"','"&smallclass&"','"&rs_produit("title")&"','"&nowhuohao&"',"&rs_ku("id")&",'"&rs_ku("ku")&"',"&nowshulian&",'"&rs_produit("guige")&"',"&nowid_login&",'"&rs_login("username")&"',0,#"&date()&"#,"&nowprice2&",'"&rs_produit("photo")&"',"&nowid_gys&",'"&nowgys&"','"&nowbianhao&"')"
conn.execute(sql)
end if
next
sql="insert into buy(batch,orderid,shulian,id_login,login,type,selldate,price2,id_gys,gys,bianhao,zu) values('"&batch&"','"&orderid&"',"&totalshulian&","&nowid_login&",'"&rs_login("username")&"',0,#"&date()&"#,"&totalprice2&","&nowid_gys&",'"&nowgys&"','"&nowbianhao&"',true)"
conn.execute(sql)
%>
<script language="javascript">
alert("产品入库成功！")
...
orderid=request("orderid")
batch=request("batch")
sql="insert into buy(batch,orderid,id_produit,bigclass,smallclass,title,huohao,id_ku,ku,shulian,guige,id_login,login,type,selldate,price2,photo,id_gys,gys,bianhao) values('"&batch&"','"&orderid&"',"&rs_produit("id")&",'"&rs_bigclass(0)&"','"&smallclass&"','"&nowtitle&"','"&nowhuohao&"',"&rs_ku("id")&",'"&rs_ku("ku")&"',"&nowshulian&",'"&nowguige&"',"&nowid_login&",'"&rs_login("username")&"',0,#"&date()&"#,"&nowprice2&",'"&nowphoto&"',"&nowid_gys&",'"&nowgys&"','"&nowbianhao&"')"
conn.execute(sql)
nowprice2=nowprice2*nowshulian
orderid=request("orderid")
batch=request("batch")
sql="insert into buy(batch,orderid,shulian,id_login,login,type,selldate,price2,id_gys,gys,bianhao,zu) values('"&batch&"','"&orderid&"',"&nowshulian&","&nowid_login&",'"&rs_login("username")&"',0,#"&date()&"#,"&nowprice2&","&nowid_gys&",'"&nowgys&"','"&nowbianhao&"',true)"
conn.execute(sql)
%>
<script language="javascript">
alert("新产品入库成功！")
...
<table align="center" cellpadding="4" cellspacing="1" class="toptable grid" border="1">
          ...
          <table cellpadding="0" cellspacing="0" width="100%" border=0>
		    ...
		    <tr id="cailiaohan<%=x%>"<%if x<>1 then%> style="display:none;"<%end if%>>
			  <td>
				...
				数量: <input type="text" name="shulian<%=x%>" style="width:40px" onKeyPress="javascript:CheckNum();" onKeyUp="this.value=this.value.replace(/[^\d.]/g,'')" onafterpaste="this.value=this.value.replace(/[^\d.]/g,'')" value="1">
				单价: <input type="text" name="price2<%=x%>" style="width:50px" onKeyPress="javascript:CheckNum();" onKeyUp="value=value.replace(/[^\d.]/g,'')" onbeforepaste="clipboardData.setData('text',clipboardData.getData('text').replace(/[^\d.]/g,''))">
				<%
	  ...
	  <tr>
        ...
        <td class="category">
		  <input name="orderid" value="<%=orderid%>" style="width:150px">
		</td>
      </tr>
	  <tr>
	    <td align="right" height="30">批号：</td>
        <td class="category">
		  <input name="batch" value="<%=batch%>" style="width:150px">
		</td>
      </tr>
	  <tr>
...
<table align="center" cellpadding="4" cellspacing="1" class="toptable grid" border="1">
	...
	%>
      ...
      <tr>
        ...
        <td class="category"><input type="text" name="shulian" style="width:100px" onKeyUp="this.value=this.value.replace(/[^\d.]/g,'')"  onafterpaste="this.value=this.value.replace(/[^\d.]/g,'')" value="1">
