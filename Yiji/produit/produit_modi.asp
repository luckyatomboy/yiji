...
<BODY>
<%
if fla14="0" and session("redboy_id")<>"1" then
%>
...
<table align="center" cellpadding="4" cellspacing="1" class="toptable grid" border="1">
	...
	%>
      ...
      <tr>
        ...
        <td class="category">
		  <input type="text" name="shulian" style="width:100px" onKeyUp="this.value=this.value.replace(/[^\d.]/g,'')"  onafterpaste="this.value=this.value.replace(/[^\d.]/g,'')" value="<%=rs("shulian")%>">
	...
	%>
      ...
      <tr>
        ...
        <td class="category"><input type="text" name="baojin" style="width:100px" onKeyUp="this.value=this.value.replace(/[^\d.]/g,'')"  onafterpaste="this.value=this.value.replace(/[^\d.]/g,'')" value="<%=rs("baojin")%>"> 
