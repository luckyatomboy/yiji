...
<table width="98%" border="0" cellpadding="0" cellspacing="2" align="center">
  <tr> 
    <td height="21" width="50%">
	  &nbsp;&nbsp;销售单位：
	  <input type="text" value="<%=dianming%>" size="40" style="border-bottom:solid 1 #000000;border-top:solid 0 #000000;border-left:solid 0 #000000;border-right:solid 0 #000000;">
	</td>
