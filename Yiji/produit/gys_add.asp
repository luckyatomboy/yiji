...
<BODY>
<%
if fla9="0" and session("redboy_id")<>"1" then
%>
...
function check()
{
if (document.form1.company.value=="" || document.form1.password.value=="")
{
alert("有*号的必须填写！");
return false;
}
...
<table align="center" cellpadding="4" cellspacing="1" class="toptable grid" border="1">
  ...
  <tr>
    ...
    <td class="category"><input type="text" name="password" style="width:200px">&nbsp;&nbsp;<font color="#ff0000">*</font></td>
  </tr>
  <tr>
