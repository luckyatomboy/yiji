...
<BODY>
<%
if fla10="0" and session("redboy_id")<>"1" then
%>
...
<td width="100%" background="../images/r_0.gif">
  <table cellpadding="0" cellspacing="0" width="100%">
    <tr>
      <td>&nbsp;供应商管理</td>
	  <td align="right"><%if fla9="1" or session("redboy_id")="1" then%><input type="button" value="添加供应商" onClick="window.location.href='gys_add.asp'" class="button"><%end if%>&nbsp;</td>
    </tr>
  </table>
</td>
...
<table align="center" cellpadding="4" cellspacing="1" class="toptable grid" border="1">
  <tr align="center">
	...
	<td class="category">联系人姓名</td>
	<td class="category">联系人电话</td>
	<td class="category">供应商地址</td>
