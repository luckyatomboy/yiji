...
<BODY>
<%
if fla80="0" and session("redboy_id")<>"1" then
%>
...
<%
sql="select * from zu_huiyuan where id="&request("id")
...
<table align="center" cellpadding="4" cellspacing="1" class="toptable grid" border="1">
  <tr>
    <td width="25%" height="30" align="right">会员组名称：</td>
...
nowzu=request("zu")
sql="select * from zu_huiyuan where zu='"&nowzu&"' and id<>"&request("id")
set rs=conn.execute(sql)
...
sql="update zu_huiyuan set zu='"&nowzu&"' where id="&request("id")
conn.execute(sql)
%>
<script language="javascript">
alert("会员组修改成功！")
