...
<table align="center" cellpadding="4" cellspacing="1" class="toptable grid" border="1">
      ...
      <tr>	  
        ...
        <td class="category">
		  		<input name="dongjian"  value="<%=rs("dongjian")%>" readonly <%if fla2="1" then%>onClick="JavaScript:window.open('query_license.asp?queryform=form1&licensetype=动检证&field=dongjian&field2=dongjiancom','','directorys=no,toolbar=no,status=no,menubar=no,scrollbars=yes,resizable=yes,width=1200,height=470,top=100,left=20');"<%end if%> style="cursor:hand;width:120px" value="单击选择动检许可证">
      ...
      <tr>	  
        ...
        <td class="category">
		  		<input name="zidong"  value="<%=rs("zidong")%>" readonly <%if fla2="1" then%>onClick="JavaScript:window.open('query_license.asp?queryform=form1&licensetype=自动证&field=zidong&field2=zidongcom','','directorys=no,toolbar=no,status=no,menubar=no,scrollbars=yes,resizable=yes,width=1200,height=470,top=100,left=20');"<%end if%> style="cursor:hand;width:120px" value="单击选择自动许可证">
      ...
      <tr>	  
        ...
        <td class="category">
		  		...
		  		&nbsp;&nbsp;&nbsp;币种
					...
					%>
					<select name="currency" <%if fla2="0" then%>disabled<%end if%>>
						<%
