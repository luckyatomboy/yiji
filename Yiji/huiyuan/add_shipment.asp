...
<table align="center" cellpadding="4" cellspacing="1" class="toptable grid" border="1">
      ...
      <tr>	  
        ...
        <td class="category">
		  		...
		  		&nbsp;&nbsp;&nbsp;单价
		  		<input name="price" style="width:100px" onKeyPress="javascript:CheckNum();" onKeyUp="this.value=this.value.replace(/[^\d.]/g,'')">&nbsp;/公斤
				</td>
      </tr>
      <tr>	  
        ...
        <td class="category">
		  		...
		  		&nbsp;&nbsp;&nbsp;单价
		  		<input name="price2" style="width:100px" onKeyPress="javascript:CheckNum();" onKeyUp="this.value=this.value.replace(/[^\d.]/g,'')">&nbsp;/公斤
				</td>
      </tr>
      <tr>	  
        ...
        <td class="category">
		  		...
		  		&nbsp;&nbsp;&nbsp;单价
		  		<input name="price3" style="width:100px" onKeyPress="javascript:CheckNum();" onKeyUp="this.value=this.value.replace(/[^\d.]/g,'')">&nbsp;/公斤
				</td>
      </tr>      
      <tr>	  
        ...
        <td class="category">
		  		...
		  		&nbsp;&nbsp;&nbsp;单价
		  		<input name="price4" style="width:100px" onKeyPress="javascript:CheckNum();" onKeyUp="this.value=this.value.replace(/[^\d.]/g,'')">&nbsp;/公斤
				</td>
      </tr>     
      <tr>	  
        ...
        <td class="category">
		  		...
		  		&nbsp;&nbsp;&nbsp;单价
		  		<input name="price5" style="width:100px" onKeyPress="javascript:CheckNum();" onKeyUp="this.value=this.value.replace(/[^\d.]/g,'')">&nbsp;/公斤
				</td>
      </tr>       
      <tr>	  
	    	<td align="right" height="30">动检证：</td>
        <td class="category">
		  		<input name="dongjian" readonly onClick="JavaScript:window.open('query_license.asp?queryform=form1&licensetype=动检证&field=dongjian&field2=dongjiancom','','directorys=no,toolbar=no,status=no,menubar=no,scrollbars=yes,resizable=yes,width=1200,height=470,top=100,left=20');" style="cursor:hand;width:120px" value="单击选择动检许可证">
      ...
      <tr>	  
        ...
        <td class="category">
		  		<input name="zidong" readonly onClick="JavaScript:window.open('query_license.asp?queryform=form1&licensetype=自动证&field=zidong&field2=zidongcom','','directorys=no,toolbar=no,status=no,menubar=no,scrollbars=yes,resizable=yes,width=1200,height=470,top=100,left=20');" style="cursor:hand;width:120px" value="单击选择自动许可证">
      ...
      <tr>	  
        ...
        <td class="category">
		  		...
		  		&nbsp;&nbsp;&nbsp;付款金额
		  		<input name="payment" style="width:100px" maxlength="15" onKeyPress="javascript:CheckNum();" onKeyUp="this.value=this.value.replace(/[^\d.]/g,'')">
		  		&nbsp;&nbsp;&nbsp;币种
					<%
      ...
      <tr>	  
        ...
        <td class="category">
		  		<input name="netweight" style="width:100px" maxlength="15" onKeyPress="javascript:CheckNum();" onKeyUp="this.value=this.value.replace(/[^\d.]/g,'')">
		  		&nbsp;&nbsp;&nbsp;关税
		  		<input name="tariff" style="width:100px" maxlength="15" onKeyPress="javascript:CheckNum();" onKeyUp="this.value=this.value.replace(/[^\d.]/g,'')">
		  		&nbsp;&nbsp;&nbsp;增值税
		  		<input name="vat" style="width:100px" maxlength="15" onKeyPress="javascript:CheckNum();" onKeyUp="this.value=this.value.replace(/[^\d.]/g,'')">
		  		&nbsp;&nbsp;&nbsp;保证金
		  		<input name="warranty" style="width:100px" maxlength="15" onKeyPress="javascript:CheckNum();" onKeyUp="this.value=this.value.replace(/[^\d.]/g,'')">
				</td>
      </tr>
      <tr>	  
