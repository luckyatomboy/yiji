...
<BODY>
<%
if fla79="0" and session("redboy_id")<>"1" then
%>
...
<td width="100%" background="../images/r_0.gif">
  <table cellpadding="0" cellspacing="0" width="100%">
    <tr>
      <td>&nbsp;修改 / 删除会员组</td>
	  <td align="right"><%if fla74="1" or session("redboy_id")="1" then%><input type="button" value="添加会员组" onClick="window.location.href='zu_add.asp'" class="button"><%end if%>&nbsp;</td>
    </tr>
  </table>
</td>
...
<table align="center" cellpadding="4" cellspacing="1" class="toptable grid" border="1">
  <tr align="center">
    <td height="30" class="category">会员组名称</td>
    <%if fla80="1" or session("redboy_id")="1" then%>
	<td width="8%" class="category">修改</td>
	<%end if%>
	<%if fla81="1" or session("redboy_id")="1" then%>
  ...
  <tr>
	...
	<input type="submit" value="删 除" class="button" onClick="return confirm('将同时删除此会员组下的所有会员！！！请慎重！！！\n\n确定要删除此会员组吗？')">
	<%end if%>
  </td>
  </tr></table></td></tr>   
</table>
