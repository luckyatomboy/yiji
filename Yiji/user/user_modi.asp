...
<table align="center" cellpadding="4" cellspacing="1" class="toptable grid" border="1">
      ...
      <tr>
        ...
        <td class="category">
        	采购<input type="checkbox" name="ispurchase" value="1" <%if (rs("IsPurchase")) then%> checked="checked" <%end if%>>&nbsp;&nbsp;
        	销售<input type="checkbox" name="issales" value="1" <%if (rs("IsSales")) then%> checked="checked" <%end if%>>&nbsp;&nbsp;
        	报关<input type="checkbox" name="iscustom" value="1" <%if (rs("IsCustom")) then%> checked="checked" <%end if%>>
        </td>
      </tr> 	      
      <tr>
...
if nowpassword="" then
  sql="update login set username='"&nowusername&"',quanxian='"&nowquanxian&"',position='"&nowposition&"',xinbie='"&nowxinbie&"',tel='"&nowtel&"',address='"&nowaddress&"',skype='"&nowskype&"',wechat='"&nowwechat&"',email='"&nowemail&"',ispurchase="&nowispurchase&",issales="&nowissales&",iscustom="&nowiscustom&" where id="&request("id")
else
  sql="update login set username='"&nowusername&"',password='"&md5(nowpassword)&"',quanxian='"&nowquanxian&"',position='"&nowposition&"',xinbie='"&nowxinbie&"',tel='"&nowtel&"',address='"&nowaddress&"',skype='"&nowskype&"',wechat='"&nowwechat&"',email='"&nowemail&"',ispurchase="&nowispurchase&",issales="&nowissales&",iscustom="&nowiscustom&" where id="&request("id")
end if
conn.execute(sql)
%>
<script language="javascript">
