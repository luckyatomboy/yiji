...
sql="insert into shipment(shipmentnum,trantype,status,invoicestatus,sales,agent,delivery,customer,vendor,contract,custcontract,country,material,price,memo1,salesprice1,case1,contractweight1,actualweight1,material2,price2,memo2,salesprice2,case2,contractweight2,actualweight2,material3,price3,memo3,salesprice3,case3,contractweight3,actualweight3,material4,price4,memo4,salesprice4,case4,contractweight4,actualweight4,material5,price5,memo5,salesprice5,case5,contractweight5,actualweight5,unit,incoterm,planship,destination,plant,shipdate,boarddate,case,casenumber,netweight,ladnumber,shipname,weishengzheng,dongjian,dongjiancom,zidong,zidongcom,paydate,payment,trancurrency,deliverydate,exchange,bankfare,agentfare,commission,actcost,actrevenue,planprofit,actprofit,createdate,creator) values("&nowshipment&",'"&nowtrantype&"','"&nowstatus&"','"&nowinvoicestatus&"','"&nowsales&"','"&nowagent&"','"&nowdelivery&"','"&nowcustomer&"','"&nowvendor&"','"&nowcontract&"','"&nowcustcontract&"','"&nowcountry&"','"&nowmaterial&"',"&nowprice&",'"&nowmemo1&"',"&nowsalesprice1&","&nowcase1&","&nowcontractweight1&","&nowactualweight1&",'"&nowmaterial2&"',"&nowprice2&",'"&nowmemo2&"',"&nowsalesprice2&","&nowcase2&","&nowcontractweight2&","&nowactualweight2&",'"&nowmaterial3&"',"&nowprice3&",'"&nowmemo3&"',"&nowsalesprice3&","&nowcase3&","&nowcontractweight3&","&nowactualweight3&",'"&nowmaterial4&"',"&nowprice4&",'"&nowmemo4&"',"&nowsalesprice4&","&nowcase4&","&nowcontractweight4&","&nowactualweight4&",'"&nowmaterial5&"',"&nowprice5&",'"&nowmemo5&"',"&nowsalesprice5&","&nowcase5&","&nowcontractweight5&","&nowactualweight5&",'"&nowunit&"','"&nowincoterm&"','"&nowplanship&"','"&nowdestination&"','"&nowplant&"','"&nowshipdate&"','"&nowboarddate&"','"&nowcase&"',"&nowcasenumber&","&nownetweight&",'"&nowladnumber&"','"&nowshipname&"','"&nowweisheng&"','"&nowdongjian&"','"&nowdongjiancom&"','"&nowzidong&"','"&nowzidongcom&"','"&nowpaydate&"',"&nowpayment&",'"&nowcurrency&"','"&nowdeliverydate&"',"&nowexchange&","&nowbankfare&","&nowagentfare&","&nowcommission&","&nowactcost&","&nowactrevenue&","&nowplanprofit&","&nowactprofit&",#"&now()&"#,'"&session("redboy_username")&"')"
conn.execute(sql)
%>
<script language="javascript">
//alert(&nowshipment&)
...
<table align="center" cellpadding="4" cellspacing="1" class="toptable grid" border="1">
      ...
      <tr>	  
        ...
        <td class="category">
		  		<input name="contract" value="<%=contract%>" style="width:120px" maxlength="20">
<!--20100117add-->  		
		  		&nbsp;&nbsp;&nbsp;客户合同号
		  		<input name="custcontract" value="<%=custcontract%>" style="width:120px" maxlength="20">
<!---->
				</td>
      </tr>     
      <tr>	  
...
-->
		  		...
		  		&nbsp;&nbsp;&nbsp;件数
		  		<input name="case1" style="width:60px" value=0 onKeyPress="javascript:CheckNum();">		  		
		  		&nbsp;&nbsp;&nbsp;合同重量
...
-->
		  		...
		  		&nbsp;&nbsp;&nbsp;件数
		  		<input name="case2" style="width:60px" value=0 onKeyPress="javascript:CheckNum();">		 		  		
		  		&nbsp;&nbsp;&nbsp;合同重量
...
-->
		  		...
		  		&nbsp;&nbsp;&nbsp;件数
		  		<input name="case3" style="width:60px" value=0 onKeyPress="javascript:CheckNum();">		 		  		
		  		&nbsp;&nbsp;&nbsp;合同重量
...
-->
		  		...
		  		&nbsp;&nbsp;&nbsp;件数
		  		<input name="case4" style="width:60px" value=0 onKeyPress="javascript:CheckNum();">		 		  		
		  		&nbsp;&nbsp;&nbsp;合同重量
...
-->
		  		...
		  		&nbsp;&nbsp;&nbsp;件数
		  		<input name="case5" style="width:60px" value=0 onKeyPress="javascript:CheckNum();">		 		  		
		  		&nbsp;&nbsp;&nbsp;合同重量
...
-->					
      ...
      <tr>	  
        ...
        <td class="category">
		  		...
		  		&nbsp;&nbsp;&nbsp;总件数
		  		<input name="casenumber" style="width:80px" maxlength="5" value=0 readonly >		  		
		  		&nbsp;&nbsp;&nbsp;总重量
		  		<input name="netweight" style="width:100px" maxlength="15" value=0 readonly >
				</td>
      </tr>
      <tr>	  
