...
<table width="94%" border="0" cellpadding="0" cellspacing="2" align="center" style="margin-top:18pt;margin-left:30pt;">
  ...
  <tr> 
    <th align="left">合同编号：</th>
	  <td><input type="text" value="<%=rs_shipment("custcontract")%>" size="20" style="border-bottom:solid 0 #000000;border-top:solid 0 #000000;border-left:solid 0 #000000;border-right:solid 0 #000000;"></td>
	  <th align="left">日期：</th>
...
<table width="94%" border="1" cellspacing="0" cellpadding="2" align="center" bordercolor="#000000" style="margin-top:18pt;margin-left:30pt;">
  ...
  <tr>
  	...
  	<td align="center"><%=rs_shipment("case1")%></td>
  ...
  <tr>
  	...
  	<td align="center"><%=rs_shipment("country")%></td>
  	<td align="center"><%=rs_shipment("case2")%></td>
  ...
  <tr>
  	...
  	<td align="center"><%=rs_shipment("country")%></td>
  	<td align="center"><%=rs_shipment("case3")%></td>
  ...
  <tr>
  	...
  	<td align="center"><%=rs_shipment("country")%></td>
  	<td align="center"><%=rs_shipment("case4")%></td>
  ...
  <tr>
  	...
  	<td align="center"><%=rs_shipment("country")%></td>
  	<td align="center"><%=rs_shipment("case5")%></td>
