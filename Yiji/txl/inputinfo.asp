...
<div align="center">
<br><b><font color="black" size="+1">录入企业通迅录</font></b><br><br>
<%
...
<p align="left">&nbsp;<b>姓名：<input type="text" name="lxr" size="10" style="width: 80; height: 22" class="doc_txt" maxlength="50">
	序号：<input type="text" name="xh" size="8" style="width: 80; height: 22" class="doc_txt" maxlength="8" onkeypress="javascript:CheckNum();">
	</b>
					</td>
                  </tr>
                </table>
...
<input type="text" name="dzyj" size="20" style="width: 174; height: 22" class="doc_txt" maxlength="80">
                  ...
                  <tr>
                    <td width="50%" height="25">&nbsp;<b>职务：</b><input type="text" name="zw" size="20" style="width: 177; height: 22" class="doc_txt"  maxlength="50"></td>

                    <td width="50%" height="25">&nbsp;<b>路电：</b><input type="text" name="ld" size="20" style="width: 177; height: 22" class="doc_txt"  maxlength="50"></td>
                  </tr>
                  <tr>
                     <td width="50%" height="25">&nbsp;<b>部门与处室：</b><input type="text" name="bmcs" size="20" style="width: 137; height: 22" class="doc_txt"  maxlength="50"></td>

                    <td width="50%" height="25">&nbsp;<b>主管工作：</b><input type="text" name="zggz" size="20" style="width: 137; height: 22" class="doc_txt"  maxlength="50"></td>
                  </tr>
                  <tr>             	

                  <td width="50%" height="25">&nbsp;<b>手机号码：</b><input type="text" name="sjhm" size="20" style="width: 137; height: 22" class="doc_txt"  maxlength="50"></td>
                  </tr>
                  <tr>
