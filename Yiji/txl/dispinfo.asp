...
<br>
<p align="center"><b><font size="4"><%=lookstr%>企业通迅录<br>
</font></b>
<%
...
%>
<td   bgcolor="#EFEFEF" width="446"><a href="#" onclick ="javascript:openwinfun('dispcontent.asp?id=<%=cstr(rs("id"))%>&printflag=0','qymlwin',400,550);"><%=trim(rs("companystyle"))%></a></td>
<td   bgcolor="#EFEFEF" width="446"><a href="#" onclick ="javascript:openwinfun('dispcontent.asp?id=<%=cstr(rs("id"))%>&printflag=0','qymlwin',400,550);"><font color="red"><%=trim(rs("contact"))%></font></a></td>
