...
<input type="button" value=" 修 改 " onclick="javascript:location.href='editcontent.asp?printflag=1&id=<%=id%>'">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
<input type="button" value=" 删 除 " onclick="javascript:location.href='delcontent.asp?printflag=1&id=<%=id%>'">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
