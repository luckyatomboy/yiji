...
<BODY>
<%
if fla48="0" and session("redboy_id")<>"1" then
%>
...
<td width="100%" background="../images/r_0.gif">
  <table cellpadding="0" cellspacing="0" width="100%">
    <tr>
      <td>&nbsp;修改 / 删除大类</td>
	  <td align="right"><%if fla47="1" or session("redboy_id")="1" then%><input type="button" value="添加大类" onClick="window.location.href='bigclass_add.asp'" class="button"><%end if%>&nbsp;</td>
    </tr>
  </table>
</td>
...
<table align="center" cellpadding="4" cellspacing="1" class="toptable grid" border="1">
  <tr align="center">
    ...
    <%if fla49="1" or session("redboy_id")="1" then%>
	<td width="8%" class="category">修改</td>
	<%end if%>
	<%if fla50="1" or session("redboy_id")="1" then%>
