...
<BODY>
<%
if fla43="0" and session("redboy_id")<>"1" then
%>
    ...
    <td class="category">
		  ...
		  %>
		    <tr>
			  ...
			  <td align="center"><input type="checkbox" name="fuzeren" value="<%=trim(cstr(rs_login("id")))%>"></td>
			</tr>
		  <%
		    rs_login.movenext
		  loop
...
moren=request("moren")
sql="select * from ku where ku='"&ku&"'"
