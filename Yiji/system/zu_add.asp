...
<BODY>
<%
if fla74="0" and session("redboy_id")<>"1" then
%>
...
<table align="center" cellpadding="4" cellspacing="1" class="toptable grid" border="1">
  <tr>
    ...
    <td width="75%" class="category">
        <input type="text" name="zu" style="width:300px">
...
nowzu=request("zu")
sql="select * from zu_login where zu='"&nowzu&"'"
...
sql="insert into zu_login(zu) values('"&nowzu&"')"
conn.execute(sql)
%>
<script language="javascript">
alert("部门添加成功！")
