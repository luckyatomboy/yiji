...
<BODY>
<%
if fla41="0" and session("redboy_id")<>"1" then
%>
...
<table align="center" cellpadding="4" cellspacing="1" class="toptable grid" border="1">
	...
	%>
      ...
      <tr>
		...
		<table cellpadding="3" cellspacing="0" width="100%" border="0">
		  <tr><td colspan="4" class="category">OA管理</td></tr>  
		  <tr>
		    <td><input type="checkbox" name="quanxian89" value="1" <%if nowfla89="1" then%>checked="checked"<%end if%>>通告管理</td>
			<td><input type="checkbox" name="quanxian90" value="1" <%if nowfla90="1" then%>checked="checked"<%end if%>> 论坛管理</td>
			<td><input type="checkbox" name="quanxian91" value="1" <%if nowfla91="1" then%>checked="checked"<%end if%>> 在线通迅录</td>
			<td><input type="checkbox" name="quanxian92" value="1" <%if nowfla92="1" then%>checked="checked"<%end if%>> 通迅录管理</td>
		  </tr>	
		  <tr>
		    <td><input type="checkbox" name="quanxian93" value="1" <%if nowfla93="1" then%>checked="checked"<%end if%>> 在线会议</td>
			<td><input type="checkbox" name="quanxian94" value="1" <%if nowfla94="1" then%>checked="checked"<%end if%>> 文件共享</td>
		    <td><input type="checkbox" name="quanxian95" value="1" <%if nowfla95="1" then%>checked="checked"<%end if%>> 共享管理</td>
			<td><input type="checkbox" name="quanxian96" value="1" <%if nowfla96="1" then%>checked="checked"<%end if%>> 邮件管理</td>
		  </tr>
		  ...
		  <tr>
		    <td><input type="checkbox" name="quanxian35" value="1" <%if nowfla35="1" then%>checked="checked"<%end if%>> 添加会员</td>
			<td><input type="checkbox" name="quanxian36" value="1" <%if nowfla36="1" then%>checked="checked"<%end if%>> 会员查询</td>
			<td><input type="checkbox" name="quanxian37" value="1" <%if nowfla37="1" then%>checked="checked"<%end if%>> 修改会员</td>
			<td><input type="checkbox" name="quanxian38" value="1" <%if nowfla38="1" then%>checked="checked"<%end if%>> 删除会员</td>
		  </tr>
		  <tr>
		    <td><input type="checkbox" name="quanxian78" value="1" <%if nowfla78="1" then%>checked="checked"<%end if%>> 添加会员组</td>
			<td><input type="checkbox" name="quanxian79" value="1" <%if nowfla79="1" then%>checked="checked"<%end if%>> 会员组查询</td>
			<td><input type="checkbox" name="quanxian80" value="1" <%if nowfla80="1" then%>checked="checked"<%end if%>> 修改会员组</td>
			<td><input type="checkbox" name="quanxian81" value="1" <%if nowfla81="1" then%>checked="checked"<%end if%>> 删除会员组</td>
		  </tr>
		  ...
		  <tr>
			...
			<td><input type="checkbox" name="quanxian60" value="1" <%if nowfla60="1" then%>checked="checked"<%end if%>> 数据备份</td>
			<td><input type="checkbox" name="quanxian61" value="1" <%if nowfla61="1" then%>checked="checked"<%end if%>> 数据还原</td>
			<td>&nbsp;</td>
		  </tr> 
		  		  <tr><td colspan="4" class="category">帐务管理</td></tr>
		  <tr>
		    <td><input type="checkbox" name="quanxian62" value="1" <%if nowfla62="1" then%>checked="checked"<%end if%>> 添加帐务大类</td>
			<td><input type="checkbox" name="quanxian63" value="1" <%if nowfla63="1" then%>checked="checked"<%end if%>> 帐务大类查询</td>
			<td><input type="checkbox" name="quanxian64" value="1" <%if nowfla64="1" then%>checked="checked"<%end if%>> 修改帐务大类</td>
			<td><input type="checkbox" name="quanxian65" value="1" <%if nowfla65="1" then%>checked="checked"<%end if%>> 删除帐务大类</td>
		  </tr>
		  <tr>
		    <td><input type="checkbox" name="quanxian66" value="1" <%if nowfla66="1" then%>checked="checked"<%end if%>> 添加帐务小类</td>
			<td><input type="checkbox" name="quanxian67" value="1" <%if nowfla67="1" then%>checked="checked"<%end if%>> 帐务小类查询</td>
			<td><input type="checkbox" name="quanxian68" value="1" <%if nowfla68="1" then%>checked="checked"<%end if%>> 修改帐务小类</td>
			<td><input type="checkbox" name="quanxian69" value="1" <%if nowfla69="1" then%>checked="checked"<%end if%>> 删除帐务小类</td>
		  </tr>
		  <tr>
		    <td><input type="checkbox" name="quanxian70" value="1" <%if nowfla70="1" then%>checked="checked"<%end if%>> 添加帐务</td>
			<td><input type="checkbox" name="quanxian71" value="1" <%if nowfla71="1" then%>checked="checked"<%end if%>> 帐务查询</td>
			<td><input type="checkbox" name="quanxian72" value="1" <%if nowfla72="1" then%>checked="checked"<%end if%>> 修改帐务</td>
			<td><input type="checkbox" name="quanxian73" value="1" <%if nowfla73="1" then%>checked="checked"<%end if%>> 删除帐务</td>
		  </tr> 

		  <tr>
		    <td><input type="checkbox" name="quanxian82" value="1" <%if nowfla82="1" then%>checked="checked"<%end if%>> 科目定义</td>
			<td><input type="checkbox" name="quanxian83" value="1" <%if nowfla83="1" then%>checked="checked"<%end if%>> 凭证管理</td>
			<td><input type="checkbox" name="quanxian84" value="1" <%if nowfla84="1" then%>checked="checked"<%end if%>> 凭证审核</td>
			<td><input type="checkbox" name="quanxian85" value="1" <%if nowfla85="1" then%>checked="checked"<%end if%>> 凭证统计</td>
		  </tr>
		  <tr>
		    <td><input type="checkbox" name="quanxian86" value="1" <%if nowfla86="1" then%>checked="checked"<%end if%>> 凭证明细</td>
			<td><input type="checkbox" name="quanxian87" value="1" <%if nowfla87="1" then%>checked="checked"<%end if%>> 凭证报表</td>
			<td><input type="checkbox" name="quanxian88" value="1" <%if nowfla88="1" then%>checked="checked"<%end if%>> 固定资产</td>
			<td> </td>
		  </tr> 
