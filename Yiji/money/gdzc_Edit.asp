...
<table cellpadding="2" cellspacing="1" class="toptable grid" border="1" width="95%"  align=center>
  <form action="gdzc_Edit2.asp?id=<%=ID%>&action=add" method=post id=form1 name=form1 onSubmit="return chk(this)">
    <tr bgcolor=ffffff> 
      <th height=25 colspan=8 align="center">固定资产信息修改</th>
    </tr>
    <tr bgcolor=ffffff> 
    ...
    <tr  bgcolor=ffffff> 
      ...
      <td width="7%" class="category"> <input name="money" type="text" id="money" onkeypress="javascript:CheckNum();" value="<%=rs("money")%>" size="10" maxlength="10"></td>
    ...
    <tr  bgcolor=ffffff> 
      <td colspan="7" align="center" class="category"><input type="submit" name="Submit" value="修 改"></td>
    </tr>
  </form>
</table>
<%
