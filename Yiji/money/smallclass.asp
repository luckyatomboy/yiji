...
<td width="100%" background="../images/r_0.gif">
  <table cellpadding="0" cellspacing="0" width="100%">
    <tr>
      <td>&nbsp;修改 / 删除小类</td>
	  <td align="right"><%if fla66="1" or session("redboy_id")="1" then%><input type="button" value="添加小类" onClick="window.location.href='smallclass_add.asp'" class="button"><%end if%>&nbsp;</td>
    </tr>
  </table>
</td>
...
<table align="center" cellpadding="4" cellspacing="1" class="toptable grid" border="1">
  ...
  <tr>
	...
	<input type="submit" value="删 除" class="button" onClick="return confirm('将同时删除属于此小类的所有帐务记录！！！请慎重！！！\n\n确定要删除此小类吗？')">
	<%end if%>
  </td>
  </tr></table></td></tr>   
</table>
